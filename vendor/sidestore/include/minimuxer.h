...
typedef enum __swift_bridge__$MinimuxerErrorTag { __swift_bridge__$MinimuxerError$NoDevice, __swift_bridge__$MinimuxerError$NoConnection, __swift_bridge__$MinimuxerError$PairingFile, __swift_bridge__$MinimuxerError$CreateDebug, __swift_bridge__$MinimuxerError$CreateInstproxy, __swift_bridge__$MinimuxerError$CreateLockdown, __swift_bridge__$MinimuxerError$CreateCoreDevice, __swift_bridge__$MinimuxerError$CreateSoftwareTunnel, __swift_bridge__$MinimuxerError$CreateRemoteServer, __swift_bridge__$MinimuxerError$CreateProcessControl, __swift_bridge__$MinimuxerError$GetLockdownValue, __swift_bridge__$MinimuxerError$Connect, __swift_bridge__$MinimuxerError$Close, __swift_bridge__$MinimuxerError$XpcHandshake, __swift_bridge__$MinimuxerError$NoService, __swift_bridge__$MinimuxerError$InvalidProductVersion, __swift_bridge__$MinimuxerError$LookupApps, __swift_bridge__$MinimuxerError$FindApp, __swift_bridge__$MinimuxerError$BundlePath, __swift_bridge__$MinimuxerError$MaxPacket, __swift_bridge__$MinimuxerError$WorkingDirectory, __swift_bridge__$MinimuxerError$Argv, __swift_bridge__$MinimuxerError$LaunchSuccess, __swift_bridge__$MinimuxerError$Detach, __swift_bridge__$MinimuxerError$Attach, __swift_bridge__$MinimuxerError$CreateAfc, __swift_bridge__$MinimuxerError$RwAfc, __swift_bridge__$MinimuxerError$InstallApp, __swift_bridge__$MinimuxerError$UninstallApp, __swift_bridge__$MinimuxerError$CreateMisagent, __swift_bridge__$MinimuxerError$ProfileInstall, __swift_bridge__$MinimuxerError$ProfileRemove, __swift_bridge__$MinimuxerError$CreateFolder, __swift_bridge__$MinimuxerError$DownloadImage, __swift_bridge__$MinimuxerError$ImageLookup, __swift_bridge__$MinimuxerError$ImageRead, __swift_bridge__$MinimuxerError$Mount, } __swift_bridge__$MinimuxerErrorTag;
...
struct __swift_bridge__$ResultVoidAndErrors __swift_bridge__$startWithLogger(void* pairing_file, void* log_path, bool is_console_logging_enabled);
