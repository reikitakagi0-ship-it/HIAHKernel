...
extension MinimuxerError {
    func intoFfiRepr() -> __swift_bridge__$MinimuxerError {
        switch self {
            ...
            case MinimuxerError.CreateLockdown:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$CreateLockdown; return val }()
            case MinimuxerError.CreateCoreDevice:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$CreateCoreDevice; return val }()
            case MinimuxerError.CreateSoftwareTunnel:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$CreateSoftwareTunnel; return val }()
            case MinimuxerError.CreateRemoteServer:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$CreateRemoteServer; return val }()
            case MinimuxerError.CreateProcessControl:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$CreateProcessControl; return val }()
            case MinimuxerError.GetLockdownValue:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$GetLockdownValue; return val }()
            case MinimuxerError.Connect:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$Connect; return val }()
            case MinimuxerError.Close:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$Close; return val }()
            case MinimuxerError.XpcHandshake:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$XpcHandshake; return val }()
            case MinimuxerError.NoService:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$NoService; return val }()
            case MinimuxerError.InvalidProductVersion:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$InvalidProductVersion; return val }()
            ...
            case MinimuxerError.CreateFolder:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$CreateFolder; return val }()
            case MinimuxerError.DownloadImage:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$DownloadImage; return val }()
            case MinimuxerError.ImageLookup:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$ImageLookup; return val }()
            case MinimuxerError.ImageRead:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$ImageRead; return val }()
            case MinimuxerError.Mount:
                return {var val = __swift_bridge__$MinimuxerError(); val.tag = __swift_bridge__$MinimuxerError$Mount; return val }()
        }
    }
}
extension __swift_bridge__$MinimuxerError {
    func intoSwiftRepr() -> MinimuxerError {
        switch self.tag {
            ...
            case __swift_bridge__$MinimuxerError$CreateLockdown:
                return MinimuxerError.CreateLockdown
            case __swift_bridge__$MinimuxerError$CreateCoreDevice:
                return MinimuxerError.CreateCoreDevice
            case __swift_bridge__$MinimuxerError$CreateSoftwareTunnel:
                return MinimuxerError.CreateSoftwareTunnel
            case __swift_bridge__$MinimuxerError$CreateRemoteServer:
                return MinimuxerError.CreateRemoteServer
            case __swift_bridge__$MinimuxerError$CreateProcessControl:
                return MinimuxerError.CreateProcessControl
            case __swift_bridge__$MinimuxerError$GetLockdownValue:
                return MinimuxerError.GetLockdownValue
            case __swift_bridge__$MinimuxerError$Connect:
                return MinimuxerError.Connect
            case __swift_bridge__$MinimuxerError$Close:
                return MinimuxerError.Close
            case __swift_bridge__$MinimuxerError$XpcHandshake:
                return MinimuxerError.XpcHandshake
            case __swift_bridge__$MinimuxerError$NoService:
                return MinimuxerError.NoService
            case __swift_bridge__$MinimuxerError$InvalidProductVersion:
                return MinimuxerError.InvalidProductVersion
            ...
            case __swift_bridge__$MinimuxerError$CreateFolder:
                return MinimuxerError.CreateFolder
            case __swift_bridge__$MinimuxerError$DownloadImage:
                return MinimuxerError.DownloadImage
            case __swift_bridge__$MinimuxerError$ImageLookup:
                return MinimuxerError.ImageLookup
            case __swift_bridge__$MinimuxerError$ImageRead:
                return MinimuxerError.ImageRead
            case __swift_bridge__$MinimuxerError$Mount:
                return MinimuxerError.Mount
            default:
...
public func startWithLogger<GenericIntoRustString: IntoRustString>(_ pairing_file: GenericIntoRustString, _ log_path: GenericIntoRustString, _ is_console_logging_enabled: Bool) throws -> () {
    try { let val = __swift_bridge__$startWithLogger({ let rustString = pairing_file.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = log_path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), is_console_logging_enabled); switch val.tag { case __swift_bridge__$ResultVoidAndErrors$ResultOk: return case __swift_bridge__$ResultVoidAndErrors$ResultErr: throw val.payload.err.intoSwiftRepr() default: fatalError() } }()
}
